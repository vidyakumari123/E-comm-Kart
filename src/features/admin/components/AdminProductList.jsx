          ...
          <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex items-baseline justify-between border-b border-gray-200 pt-24 pb-6">
              ...
              <div className="flex items-center">
                ...
                <button
                  type="button"
                  className="-m-2 ml-5 p-2 text-gray-400 hover:text-gray-600 sm:ml-7"
                >
                ...
                <button
                  ...
                  className="-m-2 ml-4 p-2 text-gray-400 hover:text-gray-600 sm:ml-6 "
                >
                ...
                <div className="lg:col-span-3">
                  <div className="flex justify-end mb-6 px-4 sm:px-0">
                    <Link
                      ...
                      className="group flex items-center rounded-xl bg-green-600 px-5 py-3 text-sm font-semibold text-white shadow-sm hover:bg-green-500 hover:-translate-y-0.5 transition-all duration-200"
                    >
          ...
          {Array.isArray(products) &&
            products.map((product) => (
              <div key={product.id} className="flex flex-col">
                <Link to={`/product-detail/${product.id}`} className="group relative bg-white border border-gray-100 rounded-2xl shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 ease-in-out cursor-pointer flex flex-col h-full overflow-hidden">
                ...
                <div className="mt-4 w-full">
                  <Link
                    ...
                    className="flex w-full justify-center items-center rounded-xl bg-white border-2 border-indigo-600 px-4 py-2.5 text-sm font-bold text-indigo-600 hover:bg-indigo-600 hover:text-white transition-all duration-200 shadow-sm"
                  >
                    Edit Product
                  </Link>
                </div>
